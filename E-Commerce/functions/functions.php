...
function getPro($flag = ''){
    ...
    if($count_pro==0){
        echo "<h2> No Product found in the selected criteria! </h2>";
    }
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        echo "
                <div class='single_product'>
                    <h3 style='padding-bottom:15px'>$pro_title</h3>
                    <img src='admin/product_images/$pro_image' width='180' height='180' padding-top='20px'>
                    <p> <b> BDT $pro_price/-  </b> </p>
                    <a href='details.php?pro_id=$pro_id' style='float: left;text-decoration:none;color:black'><button style='float: left;font-weight:bold; margin-top:20px; border-radius:20px;padding:5px'>Details</button></a>
                    <a href='index.php?add_cart=$pro_id'><button style='float: right;font-weight:bold; margin-top:20px;border-radius:20px;padding:5px'>Add to Cart</button></a>
                </div>
        ";
    }
}
